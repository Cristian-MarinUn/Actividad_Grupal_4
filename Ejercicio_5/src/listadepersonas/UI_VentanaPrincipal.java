...
public class UI_VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background.add(txt_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 200, 200, 20));
        ...
        background.add(txt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 200, 20));
        ...
        background.add(pnl_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 90, 30));
        ...
        background.add(pnl_eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 260, 90, 30));
        ...
        background.add(lbl_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 200, 70, 20));

        lbl_telefono.setFont(new java.awt.Font("Roboto Light", 1, 12)); // NOI18N
        lbl_telefono.setForeground(new java.awt.Color(0, 0, 0));
        lbl_telefono.setText("Teléfono:");
        background.add(lbl_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 160, 70, 20));
        ...
        background.add(pnl_eliminarLista, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 360, 90, 40));

        lista_menu.setBackground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(lista_menu);

        background.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, 360, 200));

        bourder.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 4));
        background.add(bourder, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 720, 460));

        lbl_img_persona.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_img_persona.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/unal_cielo.png"))); // NOI18N
        lbl_img_persona.setToolTipText("");
        background.add(lbl_img_persona, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 220, 430));
        ...
        background.add(pnl_borrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 150, -1, -1));
