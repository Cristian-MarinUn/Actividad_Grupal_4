...
public class UI_VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bourder = new javax.swing.JLabel();
        ...
        pnl_barra.setBackground(new java.awt.Color(0, 153, 255));
        ...
        exitLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, exitLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_exit, javax.swing.GroupLayout.DEFAULT_SIZE, 38, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        pnl_barraLayout.setVerticalGroup(
            ...
            .addGroup(pnl_barraLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_titlte)
                .addContainerGap(7, Short.MAX_VALUE))
            .addComponent(exit, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );

        jPanel1.add(pnl_barra, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 720, 30));
        ...
        jPanel1.add(txt_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 80, 200, 20));
        ...
        jPanel1.add(txt_apellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 120, 200, 20));
        ...
        jPanel1.add(txt_direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 200, 200, 20));
        ...
        jPanel1.add(txt_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 160, 200, 20));

        pnl_agregar.setBackground(new java.awt.Color(0, 153, 255));
        ...
        jPanel1.add(pnl_agregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 110, 90, 30));

        pnl_eliminar.setBackground(new java.awt.Color(0, 153, 255));
        ...
        jPanel1.add(pnl_eliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 260, 90, 30));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, -1, 340));

        lbl_nombres.setFont(new java.awt.Font("Roboto Light", 1, 12)); // NOI18N
        lbl_nombres.setForeground(new java.awt.Color(0, 0, 0));
        lbl_nombres.setText("Nombres:");
        jPanel1.add(lbl_nombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 80, 60, 20));
        ...
        jPanel1.add(lbl_nombres1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 120, 70, 20));

        lbl_nombres2.setFont(new java.awt.Font("Roboto Light", 1, 12)); // NOI18N
        lbl_nombres2.setForeground(new java.awt.Color(0, 0, 0));
        lbl_nombres2.setText("Dirección:");
        jPanel1.add(lbl_nombres2, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 200, 70, 20));

        lbl_nombres3.setFont(new java.awt.Font("Roboto Light", 1, 12)); // NOI18N
        lbl_nombres3.setForeground(new java.awt.Color(0, 0, 0));
        lbl_nombres3.setText("Teléfono:");
        jPanel1.add(lbl_nombres3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 160, 70, 20));

        pnl_eliminarLista.setBackground(new java.awt.Color(0, 153, 255));
        ...
        pnl_eliminarListaLayout.setHorizontalGroup(
            ...
            .addComponent(lbl_eliminarLista, javax.swing.GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
        );
        pnl_eliminarListaLayout.setVerticalGroup(
            pnl_eliminarListaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_eliminarLista, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );

        jPanel1.add(pnl_eliminarLista, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 360, 90, 40));

        lista_menu.setBackground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(lista_menu);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 240, 360, 200));

        bourder.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 4));
        jPanel1.add(bourder, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 720, 460));

        lbl_img_persona.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_img_persona.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/personas.png"))); // NOI18N
        lbl_img_persona.setToolTipText("");
        jPanel1.add(lbl_img_persona, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 220, 430));

        pnl_borrar.setBackground(new java.awt.Color(0, 153, 255));
        ...
        jPanel1.add(pnl_borrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 150, -1, -1));
    ...
    private void lbl_agregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_agregarMouseClicked
        ...
        class_persona p = new class_persona(Nom,Apll,Tele, Dire);
        ...
        //for(int i=0;i <= class_listaPersonas.personas.size() ;i++){
        //    System.out.println();
        //}
    ...
    private void lbl_eliminarListaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_eliminarListaMouseClicked
        //elimina todos los items que exiten en la lista
        int eliminar_todo = lista_menu.getSelectedIndex();
        modelo.removeAllElements();
        //elimina todo los item del array de class_listaPersonas
        lista.borrarLista();
    ...
    private void lbl_agregarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_agregarMouseEntered
        pnl_agregar.setBackground(new Color(2,123,224));
    ...
    private void lbl_agregarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_agregarMouseExited
        pnl_agregar.setBackground(new Color(0, 153, 255));
    ...
    private void lbl_borrarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_borrarMouseEntered
        pnl_borrar.setBackground(new Color(2,123,224));
    ...
    private void lbl_borrarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_borrarMouseExited
        pnl_borrar.setBackground(new Color(0, 153, 255));
    ...
    private void lbl_eliminarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_eliminarMouseEntered
        pnl_eliminar.setBackground(new Color(2,123,224));
    ...
    private void lbl_eliminarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_eliminarMouseExited
        pnl_eliminar.setBackground(new Color(0, 153, 255));
    ...
    private void lbl_eliminarListaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_eliminarListaMouseEntered
        pnl_eliminarLista.setBackground(new Color(2,123,224));
    ...
    private void lbl_eliminarListaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_eliminarListaMouseExited
        pnl_eliminarLista.setBackground(new Color(0, 153, 255));
    ...
    private void lbl_exitMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_exitMouseExited
        exit.setBackground(new Color(0, 153, 255));
    ...
    private void lbl_exitMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_exitMouseEntered
        exit.setBackground(new Color(2,123,224));
        //lbl_exit.setForeground(Color.white);
    ...
    private javax.swing.JLabel bourder;
